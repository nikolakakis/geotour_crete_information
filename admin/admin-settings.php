...
function geotour_admin_enqueue_scripts($hook) {
    // $hook gives you the current admin page
    if ('toplevel_page_geotour-crete-information' === $hook) {
        // Only enqueue scripts and styles on the geotour-crete-information page
        ...
        wp_enqueue_style('geotour-admin-styles', plugin_dir_url(__FILE__) . 'css/admin-styles.css', array(), '1.0.0'); // Enqueue admin styles
        wp_enqueue_script('geotour-index', plugin_dir_url(__FILE__) . '../build/index.js', array('jquery'), '1.0.0', true); // Enqueue index.js
        wp_enqueue_style('geotour-index-styles', plugin_dir_url(__FILE__) . '../build/index.css', array(), '1.0.0'); // Enqueue index.css
